    ...
    return (
        <div>
            ...
            <div className="type-writer-container">
                <TypeWriter
                    text="Welcome to AgroLink Digital Marketplace"
            ...
            <div className="overlay-content">
                ...
                <a className="profile" href="/seedseller">
                    <img
                ...
                <p className="profile-name">Seed Seller</p>
                <a className="profile" href="/buyers">
                    <img
                        src={process.env.PUBLIC_URL + "/Profile/11100050.png"}
                        alt=""
                        className="img-user"
                    />
                </a>
                <p className="profile-name">Buyers</p>
            </div>
            ...
            <div className="welcome-text">
                ...
                <span className="AgroLink">AgroLink!</span>
            </div>
            <div className="main-paragraph">
                <p>
                    Welcome to AgroLink, your digital marketplace for a bounty of
                    ...
                    connect, and purchase with confidence. From farm to table, AgroLink
            ...
            <div className="how-it-works">
                ...
                <span className="AgroLink">Works</span>
            </div>
            ...
            <div className="our-solution">
                ...
                <span className="AgroLink">Solution</span>
            </div>
            <div className="how-it-works-paragraph">
                <p>
                    AgroLink is a digital B2B market solution that brings together
            ...
            <div className="our-solution">
                <span className="welcome">Our</span>{" "}
                <span className="AgroLink">Pricing</span>
            </div>
            <div className="how-it-works-paragraph">
            ...
            <div className="our-solution">
                ...
                <span className="AgroLink">Features</span>
            </div>
            <div className="how-it-works-paragraph">
                <p>
                    Discover how AgroLink Marketplace can benefit you and all other
            ...
            <div className="our-solution">
                ...
                <span className="AgroLink">Started</span>
            </div>
            <div className="how-it-works-paragraph">
                <p>
